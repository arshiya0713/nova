...
if ($result && $result->num_rows > 0) {
    ...
    if ($update_stmt->execute()) {
        echo json_encode(['success' => true, 'ticket_id' => $ticket_id, 'message' => 'Message updated successfully', 'handler' => 'debug']);
    } else {
    ...
    if ($insert_stmt->execute()) {
        echo json_encode(['success' => true, 'ticket_id' => $ticket_id, 'message' => 'Message recorded successfully', 'handler' => 'debug']);
    } else {
